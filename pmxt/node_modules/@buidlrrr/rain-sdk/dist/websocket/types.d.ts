...
export type MarketTradeEventName = 'EnterOption' | 'PlaceBuyOrder' | 'PlaceSellOrder' | 'ExecuteBuyOrder' | 'ExecuteSellOrder' | 'CancelBuyOrder' | 'CancelSellOrder';
export type PriceAffectingEventName = 'EnterOption' | 'ExecuteBuyOrder' | 'ExecuteSellOrder' | 'Sync';
