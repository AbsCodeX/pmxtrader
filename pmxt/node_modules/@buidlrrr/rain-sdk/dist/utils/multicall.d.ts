...
export declare function createRpcClient(rpcUrl: string): {
    account: undefined;
    batch?: {
...
export declare function multicallRead(rpcUrl: string, contracts: ContractFunctionParameters[]): Promise<readonly MulticallResult[]>;
