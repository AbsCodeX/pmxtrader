...
export function buildSellOptionRawTx(params) {
    ...
    const pricePerShareInEther = convertToWeiEthers(pricePerShare.toString(), 18);
    return {
        to: marketContractAddress,
        data: encodeFunctionData({
            abi: TradePoolAbi,
...
function buildCancelOrdersArgs(params) {
