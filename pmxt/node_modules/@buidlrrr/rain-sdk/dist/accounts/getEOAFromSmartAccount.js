...
export async function getEOAFromSmartAccount(params) {
    ...
    if (!code || code === '0x') {
        throw new Error(`Address ${smartAccountAddress} is not a smart contract. Provide a smart account address, not an EOA.`);
    }
    ...
    throw new Error(`Could not determine owner of smart account ${smartAccountAddress}. ` +
