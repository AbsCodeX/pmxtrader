...
declare const ScopeWithdrawal = "withdrawal";
 ...
 * @public
 */
declare const PartnerAccountAllowanceTypeUsdcAllowance = "USDC_ALLOWANCE";
declare const PartnerAccountAllowanceTypeCtfApproval = "CTF_APPROVAL";
/**
 * Allowance target trade direction constants.
 * @public
 */
declare const PartnerAccountAllowanceRequiredForBuy = "BUY";
declare const PartnerAccountAllowanceRequiredForSell = "SELL";
/**
 * Allowance target status constants.
 * @public
 */
declare const PartnerAccountAllowanceStatusConfirmed = "confirmed";
declare const PartnerAccountAllowanceStatusMissing = "missing";
declare const PartnerAccountAllowanceStatusSubmitted = "submitted";
declare const PartnerAccountAllowanceStatusFailed = "failed";
/**
 * Common allowance recovery error code constants.
 * @public
 */
declare const PartnerAccountAllowanceErrorPrivySponsorshipUnavailable = "PRIVY_SPONSORSHIP_UNAVAILABLE";
declare const PartnerAccountAllowanceErrorPrivySubmissionFailed = "PRIVY_SUBMISSION_FAILED";
declare const PartnerAccountAllowanceErrorRpcReadFailed = "RPC_READ_FAILED";
declare const PartnerAccountAllowanceErrorRequestBudgetExceeded = "REQUEST_BUDGET_EXCEEDED";
/**
 ...
 * @public
 */
type PartnerAccountAllowanceType = typeof PartnerAccountAllowanceTypeUsdcAllowance | typeof PartnerAccountAllowanceTypeCtfApproval | (string & {});
/**
 * Trading action that requires this allowance target.
 * @public
 */
type PartnerAccountAllowanceRequiredFor = typeof PartnerAccountAllowanceRequiredForBuy | typeof PartnerAccountAllowanceRequiredForSell | (string & {});
/**
 * Allowance recovery target status.
 * @public
 */
type PartnerAccountAllowanceStatus = typeof PartnerAccountAllowanceStatusConfirmed | typeof PartnerAccountAllowanceStatusMissing | typeof PartnerAccountAllowanceStatusSubmitted | typeof PartnerAccountAllowanceStatusFailed | (string & {});
/**
 * Allowance recovery error code.
 * @public
 */
type PartnerAccountAllowanceErrorCode = typeof PartnerAccountAllowanceErrorPrivySponsorshipUnavailable | typeof PartnerAccountAllowanceErrorPrivySubmissionFailed | typeof PartnerAccountAllowanceErrorRpcReadFailed | typeof PartnerAccountAllowanceErrorRequestBudgetExceeded | (string & {});
/**
 * Aggregate allowance readiness counts.
 * @public
 */
interface PartnerAccountAllowanceSummary {
    total: number;
    confirmed: number;
    missing: number;
    submitted: number;
 ...
 * @public
 */
interface PartnerAccountAllowanceTarget {
 ...
 * @public
 */
interface PartnerAccountAllowanceResponse {
    profileId: number;
    partnerProfileId: number;
    chainId: number;
 ...
 * @public
 */
interface RedeemServerWalletParams {
    conditionId: string;
    onBehalfOf: number;
}
/**
 ...
 * @public
 */
interface WithdrawServerWalletParams {
    amount: string;
    onBehalfOf: number;
    token?: string;
    destination?: string;
 ...
 * @public
 */
interface ServerWalletTransactionEnvelope {
    hash: string;
    userOperationHash: string;
    transactionId: string;
    walletAddress: string;
 ...
 * @public
 */
interface RedeemServerWalletResponse extends ServerWalletTransactionEnvelope {
    conditionId: string;
    marketId: number;
}
/**
 ...
 * @public
 */
interface WithdrawServerWalletResponse extends ServerWalletTransactionEnvelope {
    token: string;
    destination: string;
    amount: string;
}
 ...
 * @public
 */
interface HistoryMarketCollateral {
    symbol: string;
    id: string;
    decimals: number;
}
...
declare class PartnerAccountService {
     ...
     */
    checkAllowances(profileId: number): Promise<PartnerAccountAllowanceResponse>;
    /**
     ...
     * state.
     */
    retryAllowances(profileId: number): Promise<PartnerAccountAllowanceResponse>;
    private requireAllowanceHmacAuth;
    private partnerAccountAllowancesPath;
}
 ...
 * @public
 */
declare class ServerWalletService {
    private readonly httpClient;
    private readonly logger;
    constructor(httpClient: HttpClient, logger?: ILogger);
    redeemPositions(params: RedeemServerWalletParams): Promise<RedeemServerWalletResponse>;
    withdraw(params: WithdrawServerWalletParams): Promise<WithdrawServerWalletResponse>;
    private requireHmacAuth;
    private validateConditionId;
...
declare class PortfolioFetcher {
     ...
     * ```
     */
    getUserHistory(cursor?: string, limit?: number): Promise<HistoryResponse>;
}
