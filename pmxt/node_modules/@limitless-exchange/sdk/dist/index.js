...
__export(index_exports, {
  ...
  PartnerAccountAllowanceErrorPrivySponsorshipUnavailable: () => PartnerAccountAllowanceErrorPrivySponsorshipUnavailable,
  PartnerAccountAllowanceErrorPrivySubmissionFailed: () => PartnerAccountAllowanceErrorPrivySubmissionFailed,
  PartnerAccountAllowanceErrorRequestBudgetExceeded: () => PartnerAccountAllowanceErrorRequestBudgetExceeded,
  PartnerAccountAllowanceErrorRpcReadFailed: () => PartnerAccountAllowanceErrorRpcReadFailed,
  PartnerAccountAllowanceRequiredForBuy: () => PartnerAccountAllowanceRequiredForBuy,
  PartnerAccountAllowanceRequiredForSell: () => PartnerAccountAllowanceRequiredForSell,
  PartnerAccountAllowanceStatusConfirmed: () => PartnerAccountAllowanceStatusConfirmed,
  PartnerAccountAllowanceStatusFailed: () => PartnerAccountAllowanceStatusFailed,
  PartnerAccountAllowanceStatusMissing: () => PartnerAccountAllowanceStatusMissing,
  PartnerAccountAllowanceStatusSubmitted: () => PartnerAccountAllowanceStatusSubmitted,
  PartnerAccountAllowanceTypeCtfApproval: () => PartnerAccountAllowanceTypeCtfApproval,
  PartnerAccountAllowanceTypeUsdcAllowance: () => PartnerAccountAllowanceTypeUsdcAllowance,
  ...
  ScopeWithdrawal: () => ScopeWithdrawal,
  ServerWalletService: () => ServerWalletService,
  Side: () => Side,
...
var ScopeWithdrawal = "withdrawal";

// src/types/partner-accounts.ts
var PartnerAccountAllowanceTypeUsdcAllowance = "USDC_ALLOWANCE";
var PartnerAccountAllowanceTypeCtfApproval = "CTF_APPROVAL";
var PartnerAccountAllowanceRequiredForBuy = "BUY";
var PartnerAccountAllowanceRequiredForSell = "SELL";
var PartnerAccountAllowanceStatusConfirmed = "confirmed";
var PartnerAccountAllowanceStatusMissing = "missing";
var PartnerAccountAllowanceStatusSubmitted = "submitted";
var PartnerAccountAllowanceStatusFailed = "failed";
var PartnerAccountAllowanceErrorPrivySponsorshipUnavailable = "PRIVY_SPONSORSHIP_UNAVAILABLE";
var PartnerAccountAllowanceErrorPrivySubmissionFailed = "PRIVY_SUBMISSION_FAILED";
var PartnerAccountAllowanceErrorRpcReadFailed = "RPC_READ_FAILED";
var PartnerAccountAllowanceErrorRequestBudgetExceeded = "REQUEST_BUDGET_EXCEEDED";
...
var PARTNER_ACCOUNT_ALLOWANCE_HMAC_ONLY_ERROR = "Partner account allowance recovery requires HMAC-scoped API token auth; legacy API keys are not supported.";
var _PartnerAccountService = class _PartnerAccountService {
   ...
   */
  async checkAllowances(profileId) {
   ...
   * state.
   */
  async retryAllowances(profileId) {
    ...
    return this.httpClient.post(`${path}/retry`, {});
  }
  requireAllowanceHmacAuth(operation) {
  ...
  partnerAccountAllowancesPath(profileId) {
...
// src/server-wallets/service.ts
var import_ethers2 = require("ethers");
var CONDITION_ID_REGEX = /^0x[a-fA-F0-9]{64}$/;
var INTEGER_STRING_REGEX = /^[0-9]+$/;
var HMAC_ONLY_ERROR = "Server wallet redeem/withdraw require HMAC-scoped API token auth; legacy API keys are not supported.";
var ServerWalletService = class {
  constructor(httpClient, logger) {
    this.httpClient = httpClient;
    this.logger = logger || new NoOpLogger();
  }
  async redeemPositions(params) {
    ...
    return this.httpClient.post("/portfolio/redeem", {
      conditionId: params.conditionId,
      onBehalfOf: params.onBehalfOf
    });
  }
  async withdraw(params) {
    ...
    return this.httpClient.post("/portfolio/withdraw", {
      amount: params.amount,
      onBehalfOf: params.onBehalfOf,
      ...params.token !== void 0 ? { token: params.token } : {},
      ...params.destination !== void 0 ? { destination: params.destination } : {}
    });
  }
  requireHmacAuth(operation) {
    this.httpClient.requireAuth(operation);
    if (!this.httpClient.getHMACCredentials()) {
  ...
  validateAddress(address, fieldName) {
    if (typeof address !== "string" || !import_ethers2.ethers.isAddress(address)) {
...
var PortfolioFetcher = class {
   ...
   * ```
   */
  async getUserHistory(cursor, limit = 20) {
    ...
    try {
      ...
      this.logger.error("Failed to fetch user history", error, { cursor, limit });
      throw error;
    }
  }
};
...
var Client = class _Client {
  ...
  newOrderClient(walletOrPrivateKey, config = {}) {
    const wallet = typeof walletOrPrivateKey === "string" ? new import_ethers4.ethers.Wallet(walletOrPrivateKey) : walletOrPrivateKey;
