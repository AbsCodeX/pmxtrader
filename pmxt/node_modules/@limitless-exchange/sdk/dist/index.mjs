...
var ServerWalletService = class {
  ...
  validateAddress(address, fieldName) {
    if (typeof address !== "string" || !ethers2.isAddress(address)) {
...
var Client = class _Client {
  ...
  newOrderClient(walletOrPrivateKey, config = {}) {
    const wallet = typeof walletOrPrivateKey === "string" ? new ethers4.Wallet(walletOrPrivateKey) : walletOrPrivateKey;
